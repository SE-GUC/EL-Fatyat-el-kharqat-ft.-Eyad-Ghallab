...
const functions = {
  ...
  UpdatePayment: async () => {
    ...
    const payment = await axios.put(
      "http://localhost:3000/api/payment/5ca3c4f8c922eb80308fc75f",
      schema
    );
    return payment;
  },
  ...
  DeleteEntity: async () => {
    const Entity = await axios.delete(
      "http://localhost:3000/api/ExternalEntities/5ca12811751ad8165dfe6e65"
    );
    return Entity;
  },
  ...
  DeleteNotification: async () => {
    const Notification = await axios.delete(
      "http://localhost:3000/api/notifications/5ca0db674155fcc050e11a7e");
    return Notification;
  },
  //   ,
  ...
  updateFormssc: async (id, requestBody) => {
