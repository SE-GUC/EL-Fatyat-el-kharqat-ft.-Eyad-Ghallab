...
email: Joi.string(),
BOD_Name: Joi.string(),
BOD_Investor_Type: Joi.string().valid("Person"),
BOD_Gender: Joi.string().valid("Female","Male"),
BOD_Nationality:Joi.valid("Afghan",
"Albanian ",
" Algerian ",
"Argentinian",
"Australian ",
...
" Zambian ",
" Zimbabwean "),
BOD_TypeOfIdentityProof: Joi.string().valid("National_ID","Passport"),
