...
// Get all Forms
router.get("/", (req, res) => res.json({ data: CreatingspcForm }));
...
router.post("/", (req, res) => {
  ...
  const Facility_Address = req.body.Facility_Address;
  const Facility_Phone_Number = req.body.Facility_Phone_Number;
